...
public class MainMenuActivity extends ListActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        //} else {
		    ...
		    if (MainMenuActivity.realViewSwitcher == null) {
//		    	renderCards();
		    }
...
//			setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
    ...
    private void buildCards(JSONObject JSON) throws JSONException {
    	...
    	MainMenuActivity.realViewSwitcher = new RealViewSwitcher(getApplicationContext());
		...
		for (int i = 0; i < terms.length(); i++) {
			...
			RelativeLayout layout = (RelativeLayout) getLayoutInflater().inflate(R.layout.card, null);
			TextView textView1 = (TextView) layout.findViewById(R.id.card_term);
			TextView textView2 = (TextView) layout.findViewById(R.id.card_definition);
		...
		MainMenuActivity.realViewSwitcher.setOnScreenSwitchListener(onScreenSwitchListener);
    }
...
//    		outState.putInt("current_card", MainActivity.realViewSwitcher.getCurrentScreen());
//    	}
    }
}
